...
use application\wechat\model\Users as M;
use application\wechat\model\Messages;
...
class Users extends Base{
    ...
    protected $beforeActionList = [
        'checkAuth' =>  ['except'=>'checklogin,login,register,getverify,getphoneverifycode,checkuserphone,forgetpass,forgetpasst,forgetpasss,findpass,resetpass,getfindphone,checkfindphone,getfindemail']// 访问这些except下的方法不需要执行前置操作
    ];
    /**
     * 会员登录页
     */
