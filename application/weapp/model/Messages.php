...
use application\weapp\model\Shops;
/**
 * ============================================================================
* VIRMALL 多用户商城
...
class Messages extends Base{
    ...
    */
    public function getById(){
        ...
        $data['msgContent'] = str_replace("/application/upload","http://localhost/application/upload",htmlspecialchars_decode($data['msgContent']));
        if(!empty($data)){
          if($data['msgStatus']==0)
