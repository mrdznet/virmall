...
function initRefundGrid(){
    ...
    var cols = [
            {title:'订单编号', name:'orderNo',sortable: true, renderer: function(val,item,rowIndex){
            	var h = "";
	            if(item['orderSrc']==0){
	            	h += "<img class='order-source2' src='"+WST.conf.ROOT+"/application/admin/view/img/order_source_1.png'>";	
	            }else if(item['orderSrc']==1){
	            	h += "<img class='order-source' src='"+WST.conf.ROOT+"/application/admin/view/img/order_source_3.png'>";		
	            }else if(item['orderSrc']==2){
	            	h += "<img class='order-source' src='"+WST.conf.ROOT+"/application/admin/view/img/order_source_2.png'>";		
	            }else if(item['orderSrc']==3){
	            	h += "<img class='order-source' src='"+WST.conf.ROOT+"/application/admin/view/img/order_source_4.png'>";	
	            }else if(item['orderSrc']==4){
	            	h += "<img class='order-source' src='"+WST.conf.ROOT+"/application/admin/view/img/order_source_5.png'>";	
	            }
