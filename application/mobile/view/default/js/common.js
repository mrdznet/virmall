...
WST.upload = function(opts){
  var _opts = {};
  _opts = $.extend(_opts,{auto: true,swf: WST.conf.STATIC +'/plugins/webuploader/Uploader.swf',server:WST.U('mobile/orders/uploadPic')},opts);
...
$(function(){
	...
	/* 基础对象检测 */
	WST.conf || $.error("VirMall基础配置没有正确加载！");
