...
use application\mobile\model\Users as M;
use application\mobile\model\Messages;
...
class Users extends Base{
    ...
    protected $beforeActionList = [
          'checkAuth' =>  ['except'=>'checklogin,login,register,getverify,toregister,forgetpass,forgetpasst,forgetpasss,findpass,getfindphone,resetpass,getphoneverifycode,checkuserphone']// 访问这些except下的方法不需要执行前置操作
    ];
    /**
     * 会员登录页
     */
