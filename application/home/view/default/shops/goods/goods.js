...
function saleByPage(p){
	$('#list').html('<tr><td colspan="11"><img src="'+WST.conf.ROOT+'/application/home/view/default/img/loading.gif">正在加载数据...</td></tr>');
	var params = {};
...
function storeByPage(p){
	$('#list1').html('<tr><td colspan="11"><img src="'+WST.conf.ROOT+'/application/home/view/default/img/loading.gif">正在加载数据...</td></tr>');
	var params = {};
	params = WST.getParams('.s-query');
...
function illegalByPage(p){
	$('#list2').html('<tr><td colspan="4"><img src="'+WST.conf.ROOT+'/application/home/view/default/img/loading.gif">正在加载数据...</td></tr>');
	var params = {};
	params = WST.getParams('.s-query');
