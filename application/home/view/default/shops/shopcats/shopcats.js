...
function treeCatOpen(obj,id){
    if( $(obj).attr('class').indexOf('active') > -1 ){
        ...
        $(obj).html('<img class="wst-lfloat" style="margin-top:-3px;" src="'+WST.conf.ROOT+'/application/home/view/default/img/seller_icon_sq.png">');
        $('.tree_'+id).hide();
    }else{
    	$(obj).addClass('active');
        $(obj).html('<img class="wst-lfloat" style="margin-top:-3px;" src="'+WST.conf.ROOT+'/application/home/view/default/img/seller_icon_zk.png">');
        $('.tree_'+id).show();
    }
}
