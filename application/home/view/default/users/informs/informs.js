...
function userComplainInit(){
	 var uploader =WST.upload({
        ...
        callback:function(f,file){
          ...
          var btn = $('<div style="position:relative;top:-80px;left:60px;cursor:pointer;" ><img src="'+WST.conf.ROOT+'/application/home/view/default/img/seller_icon_error.png"></div>');
          tdiv.append(btn);
          $('#picBox').append(tdiv);
...
function informByPage(p){
  $('#list').html('<img src="'+WST.conf.ROOT+'/application/home/view/default/img/loading.gif">正在加载数据...');
  var params = {};
