...
<div style="width:960px;margin:0 auto;">
    ...
    <div id="system_agreement" class="main">
        <div class='content'>
            <p class='bold center'>VirMall安装协议</p>
			<p>版权所有(c)2016,杭州百米贩网络科技有限公司</p>
			<p style='margin-top:10px;'>用户须知：</p>
			<p style='margin-top:10px;text-indent: 2em'>感谢您选择VirMall电子商务系统（以下简称VirMall），<a target='_blank' href='http://www.baimifan.net'>VirMall</a>电子商务系统由广州商淘信息科技有限公司（以下简称本公司）基于ThinkPHP框架开发并发布的多用户电商系统。本协议是您与广州商淘信息科技有限公司之间关于您使用<a target='_blank' href='http://www.baimifan.net'>VirMall</a>电子商务系统的法律协议。无论您是个人或组织 、盈利与否、用途如何（包括以学习和研究为目的），均需仔细阅读本协议。</p>
			<p style='margin-top:10px;text-indent: 2em'>使用协议：</p>
			<p style='margin-top:10px;text-indent: 2em'>1. <a target='_blank' href='http://www.baimifan.net'>VirMall</a>不是一个自由软件！未经本公司授权，您只能在不用于商业目的的前提下对程序代码进行修改和使用；不允许对程序代码以任何形式任何目的的再发布。</p>
			<p style='text-indent: 2em'>2. 未经本公司书面授权许可无论用途如何、是否经过修改或美化、修改程度如何，只要使用本软件的整体或任何部分，软件首页顶部及页脚处的版权标识（Powered by <a target='_blank' href='http://www.baimifan.net'>VirMall</a>）和本公司下属网站（<a target='_blank' href='http://www.baimifan.net'>http://www.baimifan.net</a>） 的链接都必须保留，不能清除或修改。</p>
			<p style='margin-top:10px;text-indent: 2em'>限制条款：</p>
			<p style='text-indent: 2em'>1. 用户可通过购买《VirMall商业授权许可》以获得约定的VirMall电子商务系统的使用授权。</p>
			<p style='text-indent: 2em'>2. 禁止在 <a target='_blank' href='http://www.baimifan.net'>VirMall</a>的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。</p>
			<p style='text-indent: 2em'>3. 授权用户可以根据需要对<a target='_blank' href='http://www.baimifan.net'>VirMall</a>进行必要的修改和美化，以适应用户的网站要求。<a target='_blank' href='http://www.baimifan.net'>VirMall</a>持有产品的全部版权。授权用户可以去除VirMall网站外在的版权信息，去除外在版权信息后的产品的所有版权仍归本公司所有。</p>
            <p style='margin-top:10px;text-indent: 2em'> 免责条款：</p>
            <p style='text-indent: 2em'>1. <a target='_blank' href='http://www.baimifan.net'>VirMall</a>及所附带的文件是作为不提供任何明确的或隐含的赔偿或担保的形式出售的。</p>
            <p style='text-indent: 2em'>2. 用户同意自己承担使用本产品的风险，在适用法律允许的最大范围内，<a target='_blank' href='http://www.baimifan.net'>VirMall</a>在任何情况下不就因使用或不能使用本产品所发生的特殊的、意外的、非直接或间接的损失承担赔偿责任。即使用户已事先被<a target='_blank' href='http://www.baimifan.net'>VirMall</a>告知该损害发生的可能性。</p>
            <p style='text-indent: 2em'>3. 用户利用本产品构建的网站的任何信息内容以及导致的任何版权纠纷和法律争议及后果与<a target='_blank' href='http://www.baimifan.net'>VirMall</a>无关，<a target='_blank' href='http://www.baimifan.net'>VirMall</a>对此不承担任何责任。</p>
            <p style='margin-top:10px;text-indent: 2em'> 其他条款：</p>
            <p style='text-indent: 2em'>用户一旦开始安装使用<a target='_blank' href='http://www.baimifan.net'>VirMall</a>，即被视为完全理解并接受本协议的各项条款，在享有上述条款授予的权力的同时，受到相关的约束和限制。协议许可范围以外的行为，造成违反本协议并构成侵权的，<a target='_blank' href='http://www.baimifan.net'>VirMall</a>有权随时终止授权，责令停止损害，并保留追究相关责任的权力。</p>
            <div style='margin-top:5px;;margin-bottom:5px;'>---------------------------------------------------------------------------------------------------------------------------------------------------------</div>
            <p style='text-indent: 2em'>联系我们: 广州商淘信息科技有限公司</p>
            <p style='text-indent: 2em'>VirMall官方网站：http://www.baimifan.net</p>
            <p style='text-indent: 2em'>VirMall演示站：http://demo.baimifan.net</p>
    ...
    <div class="main" id="system_success">
        ...
        <span style="display:inline-block;margin-top:10px;">
           <span style="font-size:18px;color: red;"> 恭喜，VirMall已安装成功&nbsp;!</span><br /><br />
            安装成功后，建议删除install目录
        </span><br /><br />
        <div style="margin:0 auto;width:350px;">
        <a class="btn2" href="../index.php" target="_blank" title="跳到VirMall首页"><span>跳到VirMall首页 </span></a>&nbsp;&nbsp;
        <a class="btn2" href="../index.php/Admin/index" target="_blank" title="跳到VirMall后台"><span>跳到VirMall后台 </span></a>
        </div>
        </div>
        </div>
    </div>
